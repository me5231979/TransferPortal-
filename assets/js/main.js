...
(function () {
  ...
  makeTrainer({
    ...
    items: [
      ...
      { q: '"Eligible open roles post to Vanderbilt staff before they can post externally."',
  ...
  makeTrainer({
    ...
    items: [
      ...
      { q: 'A role you want just posted internally. When can external candidates enter the race?',
        opts: ['Immediately, alongside you', 'After the staff-first window closes', 'Whenever the hiring manager chooses'],
        answer: 1, why: 'After the staff-first window. Vanderbilt candidates get the first look, then everyone goes through the same fair interview process.' },
  ...
  if (recap) {
    var QUESTIONS = [
      ...
      { q: 'The staff-first window means…',
        opts: ['Vanderbilt staff see eligible openings before they post to the public', 'Roles stay internal-only forever', 'You must accept any offer within a set window', 'Managers get the window to counter-offer first'],
